...
public interface AuthController {
    Auth login(String username, String password) throws JSONException, NetworkException, NotFoundException, ForbiddenException, ConflictException, UnauthorizedException, MethodNotAllowedException, NoContentException;
    ...
    Auth register(String username,
                  ...
                  Float latitude,
                  Float longitude,
                  String firebaseToken) throws JSONException, NetworkException, NotFoundException, ForbiddenException, ConflictException, UnauthorizedException, MethodNotAllowedException, NoContentException;
}
