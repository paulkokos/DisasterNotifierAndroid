...
public interface UserController {
    ...
    void updateLocation(String authorization, Double latitude, Double longitude) throws ForbiddenException, MethodNotAllowedException, ConflictException, NetworkException, NotFoundException, UnauthorizedException, JSONException;

    void updateToken(String authorization, String token) throws JSONException, ForbiddenException, MethodNotAllowedException, ConflictException, NetworkException, NotFoundException, UnauthorizedException;
